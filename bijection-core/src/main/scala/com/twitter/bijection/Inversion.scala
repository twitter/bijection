...
object Inversion {
  ...
  /**
    * The analog of Exception.allCatch either where exceptions are wrapped by the InversionFailure
    * type
    */
  ...
  /**
    * Applies tests for known inversion failure before returning a success or failure
    */
