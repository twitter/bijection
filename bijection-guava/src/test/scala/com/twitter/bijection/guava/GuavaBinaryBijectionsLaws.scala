...
with BaseProperties {
  ...
  property("rts Array[Byte] -> Base32String") = isInjective[Array[Byte], Base32String]
  property("rts Array[Byte] -> Base32HEXString") = isInjective[Array[Byte], Base32HEXString]
  property("rts Array[Byte] -> Base16String") = isInjective[Array[Byte], Base16String]
}
